...
| **Standard** *(recommended)* | 8-core (e.g. Ryzen 7 3700X) | 16 GB DDR4 | RX 590 8 GB / NVIDIA equivalent | 500 GB SSD | Everything including Foundation-Sec-8B Q4 via Vulkan |
...
> *This project is designed for defensive security purposes only. All tools and integrations are used strictly within authorized and controlled environments.*
