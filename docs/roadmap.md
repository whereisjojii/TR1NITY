...
The full week-by-week breakdown lives in [`docs/planning/03-build-pathway.md`](planning/03-build-pathway.md). This page is the short scoreboard.

For the version-controlled scoreboard, see the [`ROADMAP.md`](https://github.com/whereisjojii/TR1NITY/blob/main/ROADMAP.md) at the repo root.

## Gantt chart (Phase-1 report)
